#ifndef DIGGLER_CONTENT_IMAGE_FORMATS_PNG_LOADER_HPP
#define DIGGLER_CONTENT_IMAGE_FORMATS_PNG_LOADER_HPP
...
class PNGLoader final : public ImageLoader {
public:
...
#endif /* DIGGLER_CONTENT_IMAGE_FORMATS_PNG_LOADER_HPP */
